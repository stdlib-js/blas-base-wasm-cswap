...
```javascript
import cswap from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-cswap@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-wasm-cswap/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/blas-base-wasm-cswap/actions/workflows/test.yml?query=branch:v0.1.0
